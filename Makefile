...
BUILD_ARGS=-ldflags "-X github.com/timo-reymann/fritzbox-based-presence/pkg/buildinfo.GitSha=$(COMMIT_REF) -X github.com/timo-reymann/fritzbox-based-presence/pkg/buildinfo.Version=$(VERSION) -X github.com/timo-reymann/fritzbox-based-presence/pkg/buildinfo.BuildTime=$(NOW)"
