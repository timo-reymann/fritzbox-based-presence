...
BUILD_ARGS=-ldflags "-s -w -X github.com/timo-reymann/fritzbox-based-presence/pkg/buildinfo.GitSha=$(COMMIT_REF) -X github.com/timo-reymann/fritzbox-based-presence/pkg/buildinfo.Version=$(VERSION) -X github.com/timo-reymann/fritzbox-based-presence/pkg/buildinfo.BuildTime=$(NOW)"
BIN_PREFIX="dist/fritzbox-based-presence_"
